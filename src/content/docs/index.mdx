---
title: Pixeval
description: 基于.NET 8 和 WinUI 3 的强大、快速、漂亮的 Pixiv 第三方桌面程序
template: splash
hero:
  title: |
    欢迎来到
  ...
  tagline: 基于.NET 8 和 WinUI 3 的强大、快速、漂亮的 Pixiv 第三方桌面程序
  image:
    file: ../../assets/logo.svg
  actions:
    - text: 下载
      link: https://apps.microsoft.com/detail/Pixeval/9p1rzl9z8454?launch=true&mode=mini
      icon: right-arrow
---
...
如果你感觉该项目帮助到了你，欢迎前往[爱发电](https://afdian.cn/@dylech30th)赞助我，你的支持是我维护项目的动力，谢谢！
